...
/*
 * This class parses MailFrom Commands
 */
public class MailFromCommand extends StringToken{
	 ...
	 */
	public MailFromCommand(String string) throws InvalidCommandException, InvalidSMTPException{
	...
	public ReversePath getReversePath(){
		return reversePath;
	}
}
